    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Utilisateur'), ('organizer', 'Organisateur'), ('admin', 'Administrateur')], default='user', max_length=20)),
                ('organizer_type', models.CharField(blank=True, choices=[('individual', 'Individuel'), ('organization', 'Organisation')], max_length=20, null=True)),
